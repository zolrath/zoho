...
Invoice.prototype.updateRecord = function (module, id, params, callback) {
  ...
  if (typeof params !== 'object' || Object.keys(params).length === 0) {
    return callback({ error: 'Error: params object required to update record' }, null);
  }

  if (typeof id === 'object' || typeof id === 'undefined') {
    return callback({ error: 'Error: ID required parameter missing to update a record' }, null);
  }
...
Invoice.prototype.getRecordById = function (module, params, callback) {
  ...
  if (typeof params !== 'object' || !params.id) {
    return callback({ error: 'Error: ID required parameter missing to get record' }, null)
  }
...
Invoice.prototype.deleteRecord = function (module, id, callback) {
  if (typeof id === 'object' || typeof id === 'undefined') {
    return callback({ error: 'Error: ID required parameter missing to delete a record' }, null);
  }
